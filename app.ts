...
let pools = [
  // Testnet
  // '0x1cc6bf13edcd2e304475478d5a36ed2436eb94bb9c0498f61412cb2446a2b3de', // ETH / CETUS
  // '0xc10e379b4658d455ee4b8656213c71561b1d0cd6c20a1403780d144d90262512', // ETH / CETUS
  // '0xd40feebfcf7935d40c9e82c9cb437442fee6b70a4be84d94764d0d89bb28ab07', // USDT / USDC
  // '0x5b216b76c267098a7c19cda3956e5cbf15a5c9d225023948cb08f46197adfb05', // USDC / BTC
  // '0x83c101a55563b037f4cd25e5b326b26ae6537dc8048004c1408079f7578dd160', // USDT / USDC
  // '0x6fd4915e6d8d3e2ba6d81787046eb948ae36fdfc75dad2e24f0d4aaa2417a416', // USDT / USDC
  // '0x74dcb8625ddd023e2ef7faf1ae299e3bc4cb4c337d991a5326751034676acdae', // USDC / ETH
  // '0x40c2dd0a9395b1f15a477f0e368c55651b837fd27765395a9412ab07fc75971c', // USDT / USDC
  // '0x9978dc5bcd446a45f1ec6774e3b0706fa23b730df2a289ee320d3ab0dc0580d6'  // USDT / CETUS
...
// Strategies to use
const strategies: Strategy[] = [new RideTheTrend(5, 10)];
...
async function getAmounts(pool: string): Promise<[number, number]> {
  ...
  return [pool_info.coinAmountA, pool_info.coinAmountB];
}
    ...
    for (const pool of pools) {
      ...
      for (const strategy of strategies) {
        ...
        let decision = strategy.evaluate(
          history[pool].slice(
            history[pool].length - strategy.history_required(),
            history[pool].length
          )
        );
        if (decision != 0) {
